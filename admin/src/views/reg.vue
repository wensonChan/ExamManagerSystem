...
export default {
  ...
  methods: {
    reging() {
      this.users.name = this.adminName
      if (this.users.oldpassword != null && this.users.newpassword != null) {
        ...
        if (this.users.name != "" && this.users.password != "") {
          axios.post('/edu/admin/', "name=" + this.users.name + "&password=" + this.users.oldpassword).then((response) => {
            if (response.data.code == 200) {
              axios.post('/edu/admin/', "&newpassword=" + this.users.newpassword).then((response) => {
                if (response.data.code == 200) {
